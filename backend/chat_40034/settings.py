"""
Django settings for chat_40034 project.
...
WSGI_APPLICATION = 'chat_40034.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chat_40034 API",
    "DESCRIPTION": "API documentation for chat_40034 App",
    "VERSION": "v1",
}
